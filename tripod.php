    ...
    <div class="container-fluid product-alignment" >
        <div class="row">
            ...
            for ($i = 0; $i < $num; $i++) {
                ...
                echo "<form action='tripod.php?action=add&id=" . $productID . "&quant=' method='POST'>";
                if ($storageAmount == 0) {
                    echo "<span>";
                    echo "<select class='selectContainer' name='quant'>";
                    echo "<option value='' selected>0</option>";
                    echo "</select></span>";
                    echo "<a class='btn bg-danger' name='no_inventory' class='myBtn'><i class='fa fa-shopping-cart'></i> No Inventory</a></span>";
                } else {
                    echo "<span>";
                    echo "<select class='selectContainer' name='quant'>";
