                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="active" id="Catalog">
                        ...
                        <ul class="dropdown-menu" id="menu1">
                            ...
                            <li class="active"><a href="romantic.php">Romantic</a></li>
                        </ul>
                    </li>
    ...
    <div class="container-fluid" style="padding-left: 5%">
        <div class="row">
            ...
            <div class="col-lg-3 col-lg-offset-1 col-md-3 col-md-offset-1 col-sm-3 col-sm-offset-1 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/romantic.jpg"> <img src="images/romantic.jpg" alt="romantic" ></a>
                </div>
            </div>

            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/romantic1.jpg"> <img src="images/romantic1.jpg" alt="romantic1"></a>
                </div>
            </div>

            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/romantic3.jpg"> <img src="images/romantic3.jpg" alt="romantic3"></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-lg-offset-4 col-md-3 col-md-offset-4 col-sm-3 col-sm-offset-4 col-xs-12 ">
                <div class="thumbnail">
                    <a href="images/romantic2.jpg"> <img src="images/romantic2.jpg" alt="romantic2" ></a>
                </div>
            </div>
